...
const Footer = () => {
    ...
    return (
        <Box minHeight="80vh" sx={{ backgroundColor: "primary.dark", color: "text.light" }}>
            <Container>
                <Box sx={{ width: "100%", height: "100%", py: 4, textAlign: "center" }}>
                    <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 1, md: 3 }}>
                        ...
                        <Grid display="flex" direction="column" sx={{ gap: 2 }} item xs={12} sm={6} md={2}>
                        ...
                        <Grid display="flex" direction="column" item xs={12} sm={6} md={2}>
                            ...
                            <Box display="flex" sx={{ flexDirection: "column", gap: 1, pb: 5 }}>
                                ...
                                <Box sx={{ dispaly: "flex" }}>
                                    ...
                                    <Link style={{ textDecoration: "none" }}>
                                        <TwitterIcon sx={{ fontSize: "1.5rem", color: "#ffffff", mx: ".2rem" }} />
                                    </Link>
                                    <Link style={{ textDecoration: "none" }}>
                                        <LinkedInIcon sx={{ fontSize: "1.5rem", color: "#ffffff", mx: ".2rem" }} />
                                    </Link>
                                    <Link style={{ textDecoration: "none" }}>
                                        <YouTubeIcon sx={{ fontSize: "1.5rem", color: "#ffffff", mx: ".2rem" }} />
                                    </Link>
                                    <Link style={{ textDecoration: "none" }}>
                                        <GitHubIcon sx={{ fontSize: "1.5rem", color: "#ffffff", mx: ".2rem" }} />
                                    </Link>
                                </Box>
                            </Box>
                        </Grid>
